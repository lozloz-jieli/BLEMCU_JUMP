...
void timer_pwm_delete(JL_TIMER_TypeDef *JL_TIMERx, u32 pwm_io, u32 fre, u32 duty)
{
    gpio_disable_fun_output_port(pwm_io);
    JL_TIMERx->CON = 0;
    gpio_set_die(pwm_io, 0);
    gpio_set_dieh(pwm_io, 0);
    gpio_set_pull_up(pwm_io, 0);
    gpio_set_pull_down(pwm_io, 0);
