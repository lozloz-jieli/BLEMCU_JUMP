...
#define r_f_printf(x, ...)  printf("\e[31m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define g_f_printf(x, ...)  printf("\e[32m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
#define y_f_printf(x, ...)  printf("\e[33m\e[5m\e[1m" x "\e[0m", ## __VA_ARGS__)
