...
#define LED_TEST_PORT   				IO_PORTA_00       //ENABLE HALL_POWER ,to pull up high
#define LED_TEST_ON() 					do{gpio_set_die(LED_TEST_PORT, 1);gpio_set_direction(LED_TEST_PORT, 0);gpio_set_pull_down(LED_TEST_PORT, 0);\
	                  					gpio_set_pull_up(LED_TEST_PORT, 0);gpio_set_output_value(LED_TEST_PORT,1);}while(0)
#define LED_TEST_OFF() 					do{gpio_set_die(LED_TEST_PORT, 0);gpio_set_direction(LED_TEST_PORT, 1);gpio_set_pull_down(LED_TEST_PORT, 0);gpio_set_pull_up(LED_TEST_PORT, 0);}while(0)
#define LED_TEST_INPUT() 				do{gpio_set_die(LED_TEST_PORT, 1);gpio_set_direction(LED_TEST_PORT, 0);gpio_set_pull_down(LED_TEST_PORT, 0);\
	                  					gpio_set_pull_up(LED_TEST_PORT, 0);gpio_set_output_value(LED_TEST_PORT,0);}while(0)
