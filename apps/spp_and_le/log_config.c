...
const char log_tag_const_v_LOST AT(.LOG_TAG_CONST) = 0;
const char log_tag_const_i_LOST AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_d_LOST AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_w_LOST AT(.LOG_TAG_CONST) = 1;
const char log_tag_const_e_LOST AT(.LOG_TAG_CONST) = 1;
