...
#define TCFG_UART0_TX_PORT  				IO_PORT_DP//IO_PORTA_05//IO_PORT_DP////IO_PORTA_00                            //串口发送脚配置
...
/////////////Jimmy add hall sigals io dectect--------------------


#define  TCFG_HALL1_IO_ONE_PORT  IO_PORTB_07//IO_PORTA_06

#define  TCFG_HALL2_IO_ONE_PORT  IO_PORTB_05  // IO_PORTA_07

//#define  TCFG_HALL_POWER_PORT    //IO_PORT_DP

#define  TIME_DELAY_TO_START		3000// unit ms

#define  TIME_VIBRATER_DURATION     1000

#define TCFG_BUZZER_PIN						IO_PORTA_05 //IO_PORT_DP		//蜂鸣器PWM使用的IO口
...
/*AD通道选择，需要和AD按键的端口相对应:
    ...
    AD_CH_PB2
*/
#define TCFG_ADKEY_AD_CHANNEL               AD_CH_DM0
...
#define TCFG_ADKEY_AD0      0                                 		//0k
#define TCFG_ADKEY_AD1      (0x3ffL * 30    / (30    + R_UP))     //3.7k
 ...
 */
#define TCFG_CHARGE_MA						CHARGE_mA_120
...
#define TCFG_SKIP_ROPE_ENABLE  1
